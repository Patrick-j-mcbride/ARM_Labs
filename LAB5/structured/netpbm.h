...
typedef struct{
  rgbpixel **rows; /* pointer to array of pointers */ //8byte
  int width;       /* number of columns (length of each row) */ //4byte
  int height;      /* number of rows (length of array of pointers) */ //4byte
}rgbimage;
